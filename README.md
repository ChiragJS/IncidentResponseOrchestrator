...
- **AI-Powered Analysis**: Uses Gemini 2.5 Flash with RAG for intelligent incident analysis
...
flowchart TB
    ...
    subgraph Orchestrator["Incident Response Orchestrator"]
        ...
        subgraph Processing["Processing Layer"]
            RTR[Router Service]
            AI[AI Agent<br/>Gemini 2.5 Flash]
            POL[Policy Engine]
        end
...
|---------|----------|-------------|
| [Ingest](services/ingest/README.md) | Go | REST API for alert ingestion |
| [Router](services/router/README.md) | Go | Event enrichment & routing |
| [AI Agent](services/ai-agent/README.md) | Python | LLM-powered analysis (Gemini + RAG) |
| [Policy Engine](services/policy-engine/README.md) | Go | Action validation & guardrails |
| [Executor](services/executor/README.md) | Go | Kubernetes action execution |
...
|----------|---------|-------------|
| `GEMINI_API_KEY` | AI Agent | Google AI API key (required) |
...
| Rule | Description |
|------|-------------|
| **AllowList** | Only `restart_pod`, `scale_deployment`, `rolling_restart_deployment` permitted |
